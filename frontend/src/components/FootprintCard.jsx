...
// Formatting the date as YYYY-MM-DD
	...
	return (
		<div className="bg-primary w-[20rem] flex flex-col items-start p-4 gap-x-10 justify-center h-40 rounded-lg my-8 mx-4 cursor-pointer" >
			...
			<h1 className="text-white font-albert text-xl">{formattedDate}</h1>
